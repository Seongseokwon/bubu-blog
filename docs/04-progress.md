...
**최종 갱신**: 2026-08-04 · **현재 단계**: 기획 완료 / 구현 미착수
...
| **미결정 사항 정리** | 🟡 **대기 중** | `05-decisions.md` 14건 — **사용자 결정 필요** |
| W1 구현 | ⬜ 미착수 | — |
| W2 구현 | ⬜ 미착수 | — |
| W3 구현 | ⬜ 미착수 | — |
| W4 구현 | ⬜ 미착수 | — |
...
**W1을 시작하려면 아래 4건이 먼저 정해져야 한다.** 스키마·시드에 직접 영향을 준다.

- [ ] **D-07** '주방' 카테고리 → `living` 흡수? 복원?
- [ ] **D-08** 태그 2계층 분리 (경험방식 / 상황 / 규모)
- [ ] **D-09** `재구매/재방문/재숙박` → `wouldRepeat` 단일 통합
- [ ] **D-12** `COMPARISON` 타입 MVP 포함? v1.1 연기?
...
| 날짜 | 내용 | 다음 |
|---|---|---|
| 2026-08-04 | 문서화 체계 구축 — `CLAUDE.md`, `04-progress.md`, `05-decisions.md` 신설 | 미결정 4건 확정 후 W1 착수 |
