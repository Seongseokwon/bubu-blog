...
`docs/05-decisions.md`에 W2 이후 결정할 **미결정 10건**이 있다. W1 스키마에 직접 영향을 준 4건은 2026-08-04에 확정했다.

| # | 확정 내용 | 영향 |
|---|---|---|
| D-07 | '주방'을 `living`에 흡수하고 301 처리 | `categories` 시드·리다이렉트 |
| D-08 | 경험방식·상황·규모 태그 분리 | `tags` 스키마·시드 |
